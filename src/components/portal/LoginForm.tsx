...
export function LoginForm() {
  ...
  return (
    <div className="flex min-h-dvh">
      <BrandRail eyebrow={t("app.tagline")} title={t("login.title")} subtitle={t("login.subtitle")} />
      <div className="flex flex-1 flex-col justify-center px-5 py-10 lg:px-16">
        <div className="mx-auto flex w-full max-w-sm flex-col gap-6">
          ...
          <Card className="p-6">
            <h1 className="font-display text-xl font-bold">{t("login.heading")}</h1>
            <p className="mt-1 text-sm text-ink-soft">{t("login.subheading")}</p>
